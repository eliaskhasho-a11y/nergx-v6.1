...
Router.mount('chat', ()=>{
  ...
  <section class="card">
    <h3>Teamchatt</h3>
    <div id="teamChat" class="chat" style="height:260px"></div>
    <form id="teamForm" class="row">
      <input id="teamInput" placeholder="Skriv ett meddelande… (Enter för att skicka)" />
...
window.__hydrate = (hash)=>{
  ...
  push('Välkommen till gruppchatten!', 'ai');
